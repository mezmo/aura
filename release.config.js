...
// verifyRelease is the last step before any prepare or publish side effect.
// The tap and package repo serve stable, so only its chain touches them.
const verifyReleaseCmd = [
  './scripts/verify-release-version.sh ${nextRelease.version}',
  ...(prerelease
    ? []
    : [
