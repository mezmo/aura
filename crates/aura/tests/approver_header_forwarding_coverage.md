...
| Denial, timeout, cancellation and channel fault never proceed | `hitl::gate::tests::only_an_approval_yields_a_proceed` | Nothing to apply, so nothing may be applied |
