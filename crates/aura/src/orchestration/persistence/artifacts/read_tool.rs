...
use crate::orchestration::persistence::artifacts::storage::{
    ExecutionPersistence, lock_persistence,
};
...
pub struct ReadArtifactArgs {
    ...
    pub filename: String,
    /// Optional run ID for cross-run artifact access.
    #[serde(default)]
...
mod tests {
    ...
    use crate::scratchpad::{ContextBudget, HeadTool, ScratchpadStorage, TiktokenCounter};
    use rig::tool::Tool;
