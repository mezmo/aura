...
pub use artifacts::{
    ArtifactRef, ExecutionPersistence, SpilledArtifact, artifact_kind_from_filename,
    lock_persistence, maybe_spill_result, sanitize_filename_component,
};
...
mod tests {
    ...
    async fn test_disabled_persistence() {
        ...
        let result = persistence
            .write_plan(&super::super::types::Plan::new("test"))
            .await;
        assert!(result.is_ok());
    }
