...
* **hitl**: align request_approval timeout/cancel with config gate [8ccb077](https://github.com/mezmo/aura/commit/8ccb0777c3412b888d513f4405090d44b987c80f) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: harden conversational approval lifecycle [cf91d47](https://github.com/mezmo/aura/commit/cf91d475834d345218ce0ebadebf317337febb87) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: pass a2a request id into approval runtime [b14629a](https://github.com/mezmo/aura/commit/b14629afb6cde98c3979eba59bb33e2ab996981c) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: return channel errors as ToolError in request_approval [0573910](https://github.com/mezmo/aura/commit/0573910c3d436233d2ec0a315e506ecc99c08c62) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **skills**: initialize test config_dir and separate doc paragraph [2a277be](https://github.com/mezmo/aura/commit/2a277bee815697dc0c575c656e372bfb842da544) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)

### Code Refactoring

* **cli**: extract shared header helper for approval POST [5785c11](https://github.com/mezmo/aura/commit/5785c1145420709c8af573e2a61f2feee3026926) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **skills**: harden skill identifier and override types [3057a42](https://github.com/mezmo/aura/commit/3057a426651d3bcbebbdc0ef336aa235e17c1f39) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)

### Documentation

* **hitl**: correct glob-ordering semantics in approval gate [a2de8c9](https://github.com/mezmo/aura/commit/a2de8c902f8561eb1c2a658f17f370b5cd0759ee) - Mike Shearer* **hitl**: reflect single-agent gating and agent-requested origin [d556b8a](https://github.com/mezmo/aura/commit/d556b8ad3ac411975721382e7bbb29721d9a680d) - Mike Shearer* **readme**: defer skill validation details to the spec [32b1905](https://github.com/mezmo/aura/commit/32b190542f42a69afff11a24dabc79a85fc7df9f) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **readme**: document agent skills [51ce823](https://github.com/mezmo/aura/commit/51ce823956439cec571b09490cf7919dce1760d4) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: clean up dev comments [5f366fc](https://github.com/mezmo/aura/commit/5f366fcfb764166ae3c26bb5488332d8221bd71c) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: drop comments that restate the code [929830f](https://github.com/mezmo/aura/commit/929830fd3fd27345dbfa0da2fdf97c782258f011) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)

### Features

* add on-demand skill loading for agents [50a1a17](https://github.com/mezmo/aura/commit/50a1a17da1cab1de6b9a51351d95e1b9f7c93da8) - Mike Shearer* **hitl**: add cli approval client for conversational route [1db7e9e](https://github.com/mezmo/aura/commit/1db7e9e8bbca8ce04117934e242871b88435903d) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: add POST /v1/approvals ingress for conversational decisions [0107a1f](https://github.com/mezmo/aura/commit/0107a1f03814b3bac51000f5fdabba717d0262b1) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: add RequestCancelToken newtype and thread through decide [46c9631](https://github.com/mezmo/aura/commit/46c9631115dd35d77128827b22e680b044809881) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: cancel parked approvals on request cleanup [8a4027a](https://github.com/mezmo/aura/commit/8a4027a533ed207b2ff7ba73e017ce895a1889cb) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: implement conversational decide arm with pending sse [d23eedb](https://github.com/mezmo/aura/commit/d23eedbd76ff1342919c7166c5196ae24847dc75) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: implement registry register, resolve, and cancel_request [51f9cdb](https://github.com/mezmo/aura/commit/51f9cdb77210972c21b39420af7bb7f9d4bf9186) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: implement webhook approval gating for orchestration workers [dec0d0b](https://github.com/mezmo/aura/commit/dec0d0b8f96c25539ad52cac5553b30273e8a932) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: thread shared pending approvals through builds [61350aa](https://github.com/mezmo/aura/commit/61350aab987791680ee547d2e61de0587a925644) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **hitl**: wire approval gate for single-agent and standalone modes [626aaa8](https://github.com/mezmo/aura/commit/626aaa885285c80b70cd1d4891a29f9a260dc14d) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **orchestration**: surface skill tool calls over sse [b5d8b58](https://github.com/mezmo/aura/commit/b5d8b58f344a0f7521f104bd357ae39cef2db1ab) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: derive config_dir in standalone cli and a2a paths [b260ed2](https://github.com/mezmo/aura/commit/b260ed26e109235fc456c00d6baea451514d5429) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: load skill resources on demand via read_skill_file [2f3890b](https://github.com/mezmo/aura/commit/2f3890b1c9322a53ba6c38be41fcbad68364c3c0) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: make skill sources cwd-relative and drop config_dir [40bc402](https://github.com/mezmo/aura/commit/40bc402a64b00def0a2e89fe43529f5b6d41e9c9) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: wire skills into orchestration workers and coordinator [9f57b69](https://github.com/mezmo/aura/commit/9f57b6939bdc3e78ab78eca3aaf48b673045ea92) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)

### Tests

* **hitl**: add ingress endpoint smoke tests [f8fd663](https://github.com/mezmo/aura/commit/f8fd66391c959098eef50ee433e7d2f9bd65feed) - Mike Shearer [#191](https://github.com/mezmo/aura/issues/191)* **orchestration**: cover skill use over sse end to end [6ccaead](https://github.com/mezmo/aura/commit/6ccaeadccdc22ee7ec2e8bbb371cdb43e27cd343) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)* **skills**: cover agent.skills reaching the coordinator [1a07d21](https://github.com/mezmo/aura/commit/1a07d21740badca2e2f67fbf850110a30d46bbea) - Mike Shearer [LOG-23254](https://mezmo.atlassian.net/browse/LOG-23254)
...
* **ci**: create local branch ref for fork PR release dry-run [aab616c](https://github.com/mezmo/aura/commit/aab616cffe61f0045398395874ac44991013f431) - Tony Rogers
